            ...
            <SidebarGroupContent>
                <SidebarMenu>
                    {items.map((item) => (
                        ...
                        font-medium border border-transparent data-[active=true]:border-border data-[active=true]:shadow-[0px_1px_1px_0px_rgba(44,54,53,0.03),inset_0px_0px_0px_2px_white]"
                        >
                            {item.url ? (
                                <Link href={item.url}>
                                    <item.icon/>
...
export function DashboardSidebar() {
    ...
    const otherMenuItems: MenuItem[] = [
        ...
        },
        {
            ...
            url: "mailto:rishieflutter813@gmail.com",
            icon: Headphones,
        }
    ];
